...
do{
    ...
    case 'Add':
        console.log(chalk.yellow(`Addition Result:  ${answers.number1 + answers.number2}`));
        break;
    case 'Subract':
        console.log(chalk.yellow(`Subraction Result:  ${answers.number1 - answers.number2}`));
        break;
    case 'Multiply':
        console.log(chalk.yellow(`Multiplication Result:  ${answers.number1 * answers.number2}`));
        break;
    case 'Divide':
        console.log(chalk.yellow(`Division Result:  ${answers.number1 / answers.number2}`));
        break;
    case 'Modulus':
        console.log(chalk.yellow(`Modulus Result:  ${answers.number1 % answers.number2}`));
        break;
    }
